...
<body>
	<form action="${pageContext.request.contextPath}/pos/ps_user_update"
		...
		<c:forEach items="${ list }" var="list">
			<table id="tb_insert">
				<tr>
					<th colspan="2"><label id="lb_insert"> 아르바이트생 정보 수정
					</label></th>
				</tr>
				<tr>
				...
				<tr>
					...
					<th><input class="ipt_insert" type="password" id="pwd" name="pwd"
						value="${ list.pwd }"></th>
				</tr>
				<tr>
					<th id="tr2_insert"><img class="img_insert"
